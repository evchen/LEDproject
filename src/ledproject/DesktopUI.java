...
public class DesktopUI extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (frame == null) {
            frame = new ColorChooser(arduinocomm);
            frame.show();
        }
        else{
            frame.dispose();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        arduinocomm.comm(red, green, blue);
        
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        CodeTyper cp = new CodeTyper(arduinocomm); 
        cp.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DesktopUI dUI = new DesktopUI();
                dUI.setAlwaysOnTop(true);
                dUI.setVisible(true);
